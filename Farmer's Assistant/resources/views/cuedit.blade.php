                    ...
                    <div class="row">
                        <form class="col s12" method="POST" action="{{ route('customer.update',$customer->id) }}">
                            ...
                            <div class="row">
                                <div class="input-field col s6">
                                    <i class="material-icons prefix">home</i>
                                    <input id="username" type="text" class="validate" name="username" value="{{ $customer->username }}" >
                                    <label for="username">Username</label>
                                </div>
                                <div class="input-field col s6">
                                    <i class="material-icons prefix">phone</i>
                                    <input id="password" type="password" class="validate" name="password" value="{{ $customer->password }}"  >
